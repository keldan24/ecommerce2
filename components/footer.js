...
function Footer({ hideAuth }) {
  ...
  return (
    <div style={{ marginBottom: 'auto' }} className="vstack mt-auto">
              ...
              <div className="vstack gap-1">
                ...
                <small className="d-flex text-light text-opacity-75 gap-2">
                  <FontAwesomeIcon
                    ...
                    className="mt-1"
                  />
                  <div>123 Keldan Street, Milk Township, Nigeria.</div>
                </small>
                <small className="d-flex text-light text-opacity-75 gap-2">
                  <FontAwesomeIcon
                    icon={["fas", "envelope"]}
      ...
      <footer className="py-4 bg-primary-dark">
        <div className="container d-flex">
          <span className="text-light text-opacity-50 my-auto">
            &copy; {new Date().getFullYear()} Keldan Mart
          </span>
